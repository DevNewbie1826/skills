Read this when runtime evidence is exhausted and a user policy decision is the only remaining blocker.
...
- You've **exhausted the independent review triple** and another two rounds failed after synthesis.

## Do NOT ask when

- You have not tried the independent review triple yet.
...
- **Escalating before Phase 4.** If you have not tried the independent review triple, you have not earned the right to escalate.
