Read this when interactive native debugging needs GDB context views and pwndbg is available.

# pwndbg — GDB With the Useful Views Always On

**https://github.com/pwndbg/pwndbg**

pwndbg is a GDB plugin that adds context views and inspection commands while retaining standard GDB commands. Prefer it when installed. If it is unavailable, use standard GDB commands or lldb on platforms where that is the supported debugger; capture the same registers, stack, disassembly, and backtrace evidence.
