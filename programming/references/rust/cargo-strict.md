...
> Read this when creating or reviewing strict Rust project configuration and quality gates.
...
git add <paths>  # stage only the intended paths
# commit only when the user asked for a commit
```
