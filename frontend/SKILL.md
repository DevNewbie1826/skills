...
| An implementation or redesign that creates or updates `DESIGN.md`, or needs personas, critique, debt, handoff, or synthetic testing | The matching lane directly: [`references/designpowers/lane-a-direction.md`](references/designpowers/lane-a-direction.md) (discovery, personas, research, voice), [`lane-b-execution.md`](references/designpowers/lane-b-execution.md) (accessible content, cognitive accessibility, taste checkpoints), [`lane-c-review.md`](references/designpowers/lane-c-review.md) (critique, heuristics, persona and usability testing), or [`lane-d-memory.md`](references/designpowers/lane-d-memory.md) (debt, handoff, retrospective); each lane links its leaves. [`designpowers/README.md`](references/designpowers/README.md) is the overview. |
