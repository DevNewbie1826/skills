...
Task: explore a short sequence as screen transitions while the document stays at one position. This is discrete navigation driven by input, not a scroll-position timeline. Use the [Scene Navigation example](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/examples/scene-navigation/README.md) for a runnable contract.
...
The [Interaction Lab](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/examples/domain-interactions/README.md) provides a bounded web implementation of feedback, native disclosure, modal dismissal, stale search results, reward reveal, and range-input preview. Its [verification notes](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/examples/domain-interactions/verification.md) record exercised states and preferences; they do not establish coverage for every possible implementation of these recipes.
