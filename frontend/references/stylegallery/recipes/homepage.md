...
Use the [Harmony evaluation gate](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/quality/gates/harmony-evaluation.md) before implementation. If hierarchy, rhythm, accessibility, or source order conflict with the visual reference, the layout contract wins and the image prompt should be regenerated.
...
Next: [Quality Gates](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/quality/index.md) for claim checks, or [Layout Pattern Catalog](../CATALOG.md) when replacing a primitive.
