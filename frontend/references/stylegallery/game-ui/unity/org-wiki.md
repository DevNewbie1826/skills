...
The machine-readable source is [`data/unity-technologies-public-repositories.json`](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/game-ui/unity/data/unity-technologies-public-repositories.json). It records one row per captured public repository, including stable identity, repository URL, raw fork/archive/template state, default branch and observed HEAD when resolved, snapshot time, license metadata, UI relevance, and one exclusive `primary_cluster`.
