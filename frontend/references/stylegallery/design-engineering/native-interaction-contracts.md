...
This guide extends the [Component Contract](component-contract.md) with source-backed decisions for native HTML and custom composites. It owns product behavior, not reusable Layout CSS. The [shared accessibility evidence contract](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/quality/evidence/accessibility.md) remains the authority for evidence claims.
