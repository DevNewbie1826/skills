...
This matrix verifies consumer behavior under Design Engineering. Shared [quality gates](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/quality/index.md) own evidence admissibility. Passing a local model does not promote a domain or certify a consumer.
...
The four recipes declare integration acceptance sequences; they are not runnable browser fixtures. Existing [Interaction Lab](https://github.com/changeroa/StyleGallery/blob/2a9ae14e1ed1e6ebc9ec525a7c305a7cc9830b34/examples/domain-interactions/README.md) is a separate prototype with its own evidence scope. New recipe acceptance remains unexecuted until adapted to a consumer.
