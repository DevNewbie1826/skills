...
Read this when a design direction is genuinely contested — competing options are argued with real trade-offs, an accessibility check is applied, and the user decides.
