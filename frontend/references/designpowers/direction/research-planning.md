...
Read this when user needs are unclear, assumptions need validation, or the design brief exposes gaps in understanding — planning what to learn, which methods to use, and from whom.
