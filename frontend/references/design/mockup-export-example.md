...
Read this when you need a worked example of a portable `DESIGN.md` export.
...
### Banned Colors
- Purple/Violet neon gradients - a generic neon default
...
> **Note:** A design-mockup export may be static. This section documents the **intended motion behavior** so an implementation workflow can build animations faithfully in a live product.
...
- No generic copywriting clichés: "Elevate", "Seamless", "Unleash", "Next-Gen", "Revolutionize"
