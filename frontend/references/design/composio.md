...
1. Reference specific color names and hex codes from this document — "use Ghost White (rgba(255,255,255,0.6))" not "make it lighter"
2. Use natural language descriptions — "make the border barely visible" = Border Mist 04-06
3. Describe the desired "feel" alongside specific measurements — "compressed and authoritative heading at 48px with line-height 1.0"
4. For glow effects, specify "Electric Cyan at 12% opacity as a radial gradient behind the element"
5. Always specify which font — abcDiatype for marketing, JetBrains Mono for technical/code content
