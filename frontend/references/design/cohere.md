...
1. Always use 22px radius for primary cards — "the Cohere card roundness"
2. Specify the typeface — CohereText for headlines, Unica77 for body, CohereMono for labels
3. Interactive elements use Interaction Blue (#1863dc) on hover only
4. Keep surfaces white with cool gray borders — no warm tones
5. Purple is for full-width sections, never card backgrounds
