...
### Primary
- **Terminal Dark** (`#201d1d`): Primary background, button fills, link text. A warm near-black with subtle reddish-brown warmth -- rgb(32, 29, 29).
- **Terminal Light** (`#fdfcfc`): Primary text on dark surfaces, button text. A barely-warm off-white that avoids clinical pure white.
...
**Primary (Dark Fill)**
- Background: `#201d1d` (Terminal Dark)
- Text: `#fdfcfc` (Terminal Light)
- Padding: 4px 20px
- Radius: 4px
