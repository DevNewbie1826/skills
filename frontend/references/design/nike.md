...
2. Remember: product photography is the color — UI stays monochromatic
3. Use the grey scale for state changes: #F5F5F5 → #E5E5E5 → #CACACB → #707072
4. If something feels too colorful in the UI, it probably is — Nike keeps UI greyscale
5. Display type (Nike Futura) should ALWAYS be uppercase and never below 24px
6. Body type (Helvetica Now) should almost always be weight 500 for interactive elements
