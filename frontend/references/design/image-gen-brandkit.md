---
name: image-gen-brandkit
description: Premium brand-kit image generation skill for creating high-end brand-guidelines boards, logo systems, identity decks, and visual-world presentations. Trained for minimalist, cinematic, editorial, dark-tech, luxury, cultural, security, gaming, developer-tool, and consumer-app brand systems. Optimized for intentional logo concepting, refined composition, sparse typography, strong symbolic meaning, premium mockups, art-directed imagery, and flexible grid layouts.
---

# BRANDKIT IMAGE GENERATION SKILL

Read this when an image-generation model or design-mockup tool is available for an identity concept. If unavailable, report that and provide a written design direction instead of claiming generated boards.
...
| Topic | Read when |
|---|---|
| [Logo Concepts and Board Layouts](image-gen-brandkit/01-logo-and-board-layouts.md) | choosing a logo concept method or composing the brand board grid and panel sequence |
| [Visual Modes](image-gen-brandkit/02-visual-modes.md) | selecting the brand-specific visual direction, palette character, and mood |
| [Detail and Applications](image-gen-brandkit/03-detail-and-applications.md) | refining board details, text, taglines, imagery, or product mockups |
| [Color and Reference Use](image-gen-brandkit/04-color-and-reference-use.md) | setting color discipline, avoiding generic outcomes, or interpreting supplied references |
| [Prompt and Output](image-gen-brandkit/05-prompt-and-output.md) | assembling the generation prompt or evaluating the final output standard |
