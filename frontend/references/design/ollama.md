...
Read this when adapting a minimal, terminal-first grayscale visual language.
...
**Tab Pills**
- Pill-shaped tab selectors (e.g., "Coding" | "Automation")
- Active: Light Gray bg; Inactive: transparent
- All pill-shaped (9999px)

**Model Tags**
- Small pill-shaped tags (e.g., "local", "launch", "tools")
...
**Integration Grid**
- Grid of integration logos for development, documentation, and automation tools
- Each in a bordered pill or card with icon + name
- Tabbed by category (Coding, Documents, Automation, Chat)
...
1. Keep all values grayscale — "Stone (#737373)" not "use a light color"
2. Always specify pill (9999px) or container (12px) radius — nothing in between
3. Shadows are always zero — never add them
4. Weight is always 400 or 500 — never bold
5. If something feels too decorated, remove it — less is always more for Ollama
