...
Iteration Guide preamble: see [airbnb.md#iteration-guide](airbnb.md#iteration-guide).

#### Brand-specific iteration guidance

1. Reference specific color names and hex codes — "use Warm Parchment (#b8b3b0)" not "make it lighter"
2. Use border treatment to communicate elevation: "change the border to 2px solid Emerald Signal Green (#00d992)" for emphasis
3. Describe the desired "feel" alongside measurements — "compressed and authoritative heading at 36px with line-height 1.11 and -0.9px letter-spacing"
4. For glow effects, specify "Emerald Signal Green (#00d992) as a drop-shadow with 2–8px blur radius"
5. Always specify which font — system-ui for headings, Inter for body/UI, SFMono-Regular for code
6. Keep animations slow and subtle — marquee scrolls at 25–80s, glow pulses gently
