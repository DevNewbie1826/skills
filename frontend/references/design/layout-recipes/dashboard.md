...
Do not use this recipe for a single focused workflow. A [form flow](form-flow.md) or [content-limiter](../layout-patterns/containment/content-limiter.md) is usually clearer.

## Related Patterns

- [ram-grid](../layout-patterns/grid-repetition/ram-grid.md)
- [dense-grid](../layout-patterns/grid-repetition/dense-grid.md)
