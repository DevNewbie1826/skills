...
- [scroll-body-shell](../layout-patterns/viewport-shell/scroll-body-shell.md)
- [split-nav](../layout-patterns/in-line-grouping/split-nav.md)
- [wrap-row](../layout-patterns/in-line-grouping/wrap-row.md)
...
The shell body owns content scrolling. Command rows should wrap when possible; use [reel](../layout-patterns/in-line-grouping/reel.md) only when horizontal scanning is part of the interaction model.
...
Do not use this recipe for a simple content page with one or two actions. A [cluster](../layout-patterns/in-line-grouping/cluster.md) inside normal document flow is enough.

## Related Patterns

- [reel](../layout-patterns/in-line-grouping/reel.md)
- [panel-layout](../layout-patterns/viewport-shell/panel-layout.md)
