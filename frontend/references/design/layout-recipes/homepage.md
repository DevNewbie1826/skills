...
- [cover](../layout-patterns/viewport-shell/cover.md)
- [content-limiter](../layout-patterns/containment/content-limiter.md)
- [stack](../layout-patterns/stacking/stack.md)
- [cluster](../layout-patterns/in-line-grouping/cluster.md)
- [ram-grid](../layout-patterns/grid-repetition/ram-grid.md)
- [frame](../layout-patterns/media-fit/frame.md)
...
Evaluate harmony before implementation. If hierarchy, rhythm, accessibility, or source order conflict with the visual reference, the layout contract wins and the image prompt should be revised.
...
- [page-grid](../layout-patterns/grid-repetition/page-grid.md)
- [card-grid](../layout-patterns/grid-repetition/card-grid.md)
- [sidebar](../layout-patterns/split-sidebar/sidebar.md)
- [sticky-footer](../layout-patterns/viewport-shell/sticky-footer.md)

## IA Navigation

Parent: [Layout Recipes](index.md).
Next: [Layout Pattern Catalog](../layout-patterns/CATALOG.md) when replacing a primitive.
