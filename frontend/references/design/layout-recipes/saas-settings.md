...
Do not use this recipe for a short one-page preference form where document flow and a simple [content-limiter](../layout-patterns/containment/content-limiter.md) are enough.
