...
- [list-detail](../layout-patterns/split-sidebar/list-detail.md)
...
Do not use this recipe when the detail page is a full navigation destination. Use ordinary page navigation and a [content-limiter](../layout-patterns/containment/content-limiter.md) instead.

## Related Patterns

- [supporting-pane](../layout-patterns/split-sidebar/supporting-pane.md)
- [fixed-sidenav-shell](../layout-patterns/viewport-shell/fixed-sidenav-shell.md)
