...
| Reference | Read when |
|---|---|
| [Composition and imagery](image-gen-concepts-web/composition-and-image-direction.md) | choosing page structure, hero treatment, image use, or section-by-section image output |
| [Visual system and components](image-gen-concepts-web/visual-system-and-components.md) | selecting visual variety, typography, spacing, color, materials, or component treatments |
| [Consistency and quality](image-gen-concepts-web/consistency-and-quality.md) | checking multi-image continuity, clarity, creativity, and implementation readiness |
| [Page planning and examples](image-gen-concepts-web/page-planning-and-examples.md) | choosing a default section pack or adapting an example brief into a direction |
| [Response workflow](image-gen-concepts-web/response-workflow.md) | planning the response sequence or reviewing the final design deliverable |
