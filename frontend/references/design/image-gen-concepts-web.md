...
Read this when an image-generation model or design-mockup tool is available for web concepts. If none is available, report the limitation and use loaded design references rather than claiming generated imagery.
