...
1. Reference the strict black/white palette -- "use Uber Black (#000000)" not "make it dark"
2. Always specify 999px radius for buttons and pills -- this is non-negotiable for the Uber identity
3. Describe the font family explicitly -- "UberMove Bold for the heading, UberMoveText Medium for the label"
4. For shadows, use "whisper shadow (rgba(0,0,0,0.12) 0px 4px 16px)" -- never heavy drop shadows
5. Keep layouts compact and information-dense -- Uber is efficient, not airy
6. Illustrations should be warm and human -- describe "stylized people in warm tones" not abstract shapes
7. Pair black CTAs with white secondaries for balanced dual-action layouts
