...
- This layout collection chooses semantic structure, spatial model, constraints, pattern stack, scroll ownership, and verification.
...
If the use case is a homepage or marketing-style page, start from the [Homepage recipe](../../layout-recipes/homepage.md). If the content is mostly prose, compare it with [Article page](../../layout-recipes/article-page.md). If the content is task-heavy, compare it with [Command surface](../../layout-recipes/command-surface.md), [Form flow](../../layout-recipes/form-flow.md), or [List detail](../../layout-recipes/list-detail.md).
...
Use these routes as trace examples before generating a reference image. Each route must preserve this order: content blocks become section jobs, section jobs choose a recipe, the recipe yields a pattern stack, scroll owner and constraints are named, harmony evaluation approves the contract, and only then can a reference image be generated.

### Homepage Route

Path: Content blocks -> Section jobs -> Recipe -> Pattern stack -> Scroll owner -> Constraints -> Harmony evaluation -> reference image -> Implementation handoff
...
- Recipe: [Homepage](../../layout-recipes/homepage.md).
...
- Recipe: [Dashboard](../../layout-recipes/dashboard.md).
...
- Recipe: [Article page](../../layout-recipes/article-page.md).
...
- Recipe: [Form flow](../../layout-recipes/form-flow.md).
...
- Recipe: [Command surface](../../layout-recipes/command-surface.md).
...
Run harmony evaluation before generating images or writing implementation CSS.
...
Generate the reference image only after the use case, section jobs, semantic skeleton, pattern stack, and harmony notes are approved.
...
Do not treat a generated image as proof of usability, accessibility, or brand fit. It is a visual reference that still needs implementation and accessibility verification.
...
When a consumer-specific reference is relevant, record its repository-relative location in the handoff.
