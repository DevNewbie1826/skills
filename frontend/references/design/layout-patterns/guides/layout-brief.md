...
- What image prompt follows from the approved content hierarchy and pattern stack?
...
- Content blocks, section jobs, closest recipe, pattern stack, scroll owner, constraints, harmony evaluation, reference image, implementation handoff.

Dashboard:

- Repeated panel inventory, scan or comparison task, closest recipe, pattern stack, scroll owner, constraints, harmony evaluation, reference image, implementation handoff.

Article:

- Reading path, supplemental content, closest recipe, pattern stack, scroll owner, constraints, harmony evaluation, reference image, implementation handoff.

Form:

- Input groups, validation and action placement, closest recipe, pattern stack, scroll owner, constraints, harmony evaluation, reference image, implementation handoff.

Command surface:

- Command regions, controlled content regions, closest recipe, pattern stack, scroll owner, constraints, harmony evaluation, reference image, implementation handoff.
