# Implementation Sources and Appendices

Read this when installing a design system, checking canonical references, or approximating Apple Liquid Glass on the web.
