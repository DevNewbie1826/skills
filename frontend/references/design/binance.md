...
2. Remember: Binance Yellow (#F0B90B) is the ONLY accent color — everything else is grey/dark/white
3. Use the dark/light section alternation for visual pacing
4. Numbers and data should be prominent — this is a financial platform
5. Pill buttons (50px radius) for CTAs, regular buttons (6px radius) for form actions
6. Keep shadows almost invisible (5% opacity) — trust comes from clarity, not depth
7. BinancePlex at 600+ weight for any text that needs to feel authoritative
