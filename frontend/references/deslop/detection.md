...
non-English slop. `$SKILL_DIR/references/deslop/scripts/rules.ru.mjs` is a shipped Russian example. Remember
...
rg -n -i 'font-size:\s*(clamp\([^)]*[4-9]\.?[0-9]*rem|[5-9][0-9]px|[4-9]rem)'
```
